...
using SampleBarterApp.Sessions;
using SampleBarterApp.Web.Controllers.Results;
using SampleBarterApp.Web.Models;
using SampleBarterApp.Web.Models.Account;
...
{
    public class AccountController : SampleBarterAppControllerBase
    {
