...
(function ($) {
    ...
    $.fn.spartanMultiImagePicker = function (options) {
        ...
        var defaults = {
            ...
            onSizeErr:         function() {},
            directUpload :  {
                loaderIcon: '<i class="fa fa-refresh fa-spin"></i>',
                status:       false,
                url:          '',
                success:      function() {},
                error:        function() {}
        ...
        function addRow(settings, el){
            ...
            var uploadLoaderIcon = '<i class="fa fa-refresh fa-spin"></i>';
